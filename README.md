...
1. **Descargar e Instalar Node.js:**
   ...
   - Ejecuta el instalador (`.msi`) y asegúrate de marcar la opción que dice **"Add to PATH"** 
   
2. **Verificar la instalación:**
   - Abre una nueva terminal (CMD, PowerShell o VS Code) y escribe:
     ```bash
     node -v
     npm -v
     ```
...
1. **Clonar el repositorio** (si ya lo tienes en local, sáltate este paso):
   ```bash
   git clone https://github.com/llunajuvilla/TFG-front.git
   cd TFG-front
